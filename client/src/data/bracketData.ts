...
const rawTeams: Omit<NCAATeam, "impliedChampionshipPct">[] = [
  // ─── EAST REGION ─────────────────────────────────────────────────────────
  {
    ...
    championshipOdds: 330, ppg: 85.4, oppPpg: 66.8, scoringMargin: 18.6,
    fg2Pct: 54.2, fg3Pct: 37.8, ftPct: 74.1, threePointRate: 35,
    adjOffRating: 122.1, adjDefRating: 94.3, adjEffMargin: 27.8, pace: 70.2,
    orebRate: 32, drebRate: 74, turnoversForced: 18.2, turnoverRate: 14.1,
    keyPlayers: [{ name: "Cameron Boozer", stat: "22.7 PPG / 10.2 RPG" }, { name: "Isaiah Evans", stat: "14.5 PPG" }],
    playStyle: ["elite-scoring", "two-way", "paint-dominant", "shot-blocking"],
    strengthOfSchedule: 9.2, recentForm: "hot", conferenceFinish: "ACC Champion",
    upsetAlert: false, sleeper: false,
    analysis: "Cameron Boozer is a generational talent — the best freshmen since Zion. Duke pairs elite interior scoring with the nation's top defensive efficiency. Their experience in big games under Coach Scheyer gives them the edge in close tournament moments."
  },
  {
    id: "uconn", name: "UConn Huskies", shortName: "UConn",
    seed: 2, region: "East", record: "29-5", wins: 29, losses: 5,
    championshipOdds: 1700, ppg: 78.3, oppPpg: 65.4, scoringMargin: 12.9,
    fg2Pct: 52.1, fg3Pct: 39.8, ftPct: 72.3, threePointRate: 38,
    adjOffRating: 116.4, adjDefRating: 93.8, adjEffMargin: 22.6, pace: 67.8,
    ...
    strengthOfSchedule: 8.8, recentForm: "hot", conferenceFinish: "Big East Runner-Up",
    upsetAlert: false, sleeper: false,
    analysis: "Back-to-back champion DNA. UConn's defense is elite (top-5 nationally) and Alex Karaban provides a reliable 3PT threat. Two-time defending champions bring tournament experience others can't match. Slight regression from prior years but still dangerous."
  },
  {
    ...
    adjOffRating: 112.8, adjDefRating: 95.4, adjEffMargin: 17.4, pace: 66.1,
    ...
    upsetAlert: false, sleeper: false,
    analysis: "Tom Izzo in the tournament is worth at least a seed and a half. 7th nationally in offensive rebounding and top-10 defense. Jeremy Fears Jr. runs the show — his elite assist-to-turnover ratio is tournament-built. Ceiling is Final Four."
  },
  {
    id: "kansas", name: "Kansas Jayhawks", shortName: "Kansas",
    seed: 4, region: "East", record: "23-10", wins: 23, losses: 10,
    championshipOdds: 5000, ppg: 76.8, oppPpg: 68.4, scoringMargin: 8.4,
    ...
    analysis: "Darryn Peterson is a volume scorer who can take over games, but Kansas's 10 losses expose inconsistency against elite defenses. Their 3PT-heavy offense can go cold. Program pedigree helps but this squad has a realistic Elite Eight ceiling."
  },
  {
    id: "st-johns", name: "St. John's Red Storm", shortName: "St. John's",
    seed: 5, region: "East", record: "28-6", wins: 28, losses: 6,
    championshipOdds: 5000, ppg: 79.2, oppPpg: 68.1, scoringMargin: 11.1,
    ...
    analysis: "Nation's 12th-lowest turnover rate signals elite composure. Ejiofor is a matchup nightmare — physical, skilled, and efficient. Tested in the Big East gauntlet all year. Could be the team that ends UConn's dynasty."
  },
  {
    id: "louisville", name: "Louisville Cardinals", shortName: "Louisville",
    seed: 6, region: "East", record: "23-10", wins: 23, losses: 10,
    championshipOdds: 12000, ppg: 77.4, oppPpg: 70.2, scoringMargin: 7.2,
    fg2Pct: 60.8, fg3Pct: 32.1, ftPct: 68.9, threePointRate: 28,
    adjOffRating: 111.3, adjDefRating: 98.4, adjEffMargin: 12.9, pace: 71.2,
    ...
    upsetAlert: false, sleeper: false,
    analysis: "61% of their shots come inside the arc — one of the most paint-dominant teams in the field. Ryan Conwell can carry them, but their lack of 3PT creation makes them predictable against elite defenses. Sweet 16 ceiling likely."
  },
  {
    id: "ucla", name: "UCLA Bruins", shortName: "UCLA",
    seed: 7, region: "East", record: "23-11", wins: 23, losses: 11,
    championshipOdds: 13000, ppg: 74.8, oppPpg: 69.3, scoringMargin: 5.5,
    ...
    upsetAlert: false, sleeper: true,
    analysis: "Donovan Dent shooting 53% from 3 in his last 7 games is alarming for opponents. 11.0 APG in that stretch makes him a legitimate first-team All-American run. If their 3PT stays hot, they can beat anyone. Streaky nature cuts both ways."
  },
  {
    ...
    upsetAlert: false, sleeper: false,
    analysis: "Bruce Thornton has been on a tear — 21.8 PPG since late February with elite efficiency. 62% inside the arc + 44% from three is a rare and dangerous combination. Momentum team. Could absolutely upset Duke in the Elite Eight."
  },
  {
    id: "tcU", name: "TCU Horned Frogs", shortName: "TCU",
    seed: 9, region: "East", record: "22-11", wins: 22, losses: 11,
    championshipOdds: 30000, ppg: 71.2, oppPpg: 65.8, scoringMargin: 5.4,
    ...
    upsetAlert: false, sleeper: false,
    analysis: "Top-25 defense and forcing turnovers on 1/5 of opponents' possessions in their last 7 games. David Punch is an interior anchor. They could hold Ohio State in check but lack the offensive firepower for deeper runs."
  },
  {
    id: "ucf", name: "UCF Knights", shortName: "UCF",
    seed: 10, region: "East", record: "21-11", wins: 21, losses: 11,
    championshipOdds: 30000, ppg: 73.4, oppPpg: 68.2, scoringMargin: 5.2,
    ...
    upsetAlert: false, sleeper: false,
    analysis: "Riley Kugel and a 3PT-heavy attack make UCF dangerous in single-elimination. Their strength of schedule is a concern against Big East/ACC defenses but they have upset upside against UCLA."
  },
  {
    id: "south-florida", name: "South Florida Bulls", shortName: "USF",
    seed: 11, region: "East", record: "25-8", wins: 25, losses: 8,
    championshipOdds: 60000, ppg: 76.1, oppPpg: 68.9, scoringMargin: 7.2,
  ...
  },
  {
    ...
    championshipOdds: 150000, ppg: 68.4, oppPpg: 63.1, scoringMargin: 5.3,
    ...
    strengthOfSchedule: 6.8, recentForm: "hot", conferenceFinish: "MVC",
    upsetAlert: true, sleeper: false,
    analysis: "Top-25 defensive efficiency teams are always dangerous in March. Trey Campbell's tournament explosion adds another layer. Their slow-pace style can suffocate faster teams. Classic 12-5 upset candidate."
  },
  {
    ...
    upsetAlert: true, sleeper: false,
    analysis: "Daniels scored 32 PPG in the WAC tournament. A single high-usage scorer is always a first-round threat. But St. John's defense at #5 should limit him and their depth will win out over 40 minutes."
  },
  {
    ...
    strengthOfSchedule: 5.2, recentForm: "hot", conferenceFinish: "Summit League",
    upsetAlert: false, sleeper: false,
  ...
  },
  {
    ...
    keyPlayers: [{ name: "Alex Wilkins/Cooper Bowser", stat: "114 pts combined (SoCon tourney)" }],
    playStyle: ["up-tempo", "scoring", "mid-major-scrappy"],
    strengthOfSchedule: 5.0, recentForm: "hot", conferenceFinish: "SoCon Champion",
    upsetAlert: false, sleeper: false,
    analysis: "Furman scored 81+ PPG in their tournament run but face Duke's top defensive unit. 123.7 points/100 possessions in SoCon play is inflated. Duke holds them under 65 comfortably."
  },
  {
    ...
    strengthOfSchedule: 5.4, recentForm: "average", conferenceFinish: "MAAC",
    upsetAlert: false, sleeper: false,
  ...
  // ─── WEST REGION ─────────────────────────────────────────────────────────
  {
    ...
    championshipOdds: 425, ppg: 83.1, oppPpg: 65.9, scoringMargin: 17.2,
    fg2Pct: 54.8, fg3Pct: 37.4, ftPct: 73.2, threePointRate: 34,
    adjOffRating: 120.4, adjDefRating: 93.1, adjEffMargin: 27.3, pace: 71.4,
    orebRate: 31, drebRate: 75, turnoversForced: 19.1, turnoverRate: 13.8,
    keyPlayers: [{ name: "Brayden Burries", stat: "16.0 PPG / 37% 3PT" }, { name: "Koa Peat", stat: "13.8 PPG" }],
    ...
    upsetAlert: true, sleeper: false,
    analysis: "Arizona has the 'excellent' defensive rating per Synergy and a balanced attack with 4 players averaging double figures. However, they've lost to a 5+ lower seed 10 times historically — the most of any school. Upset alert: always with Arizona."
  },
  {
    id: "purdue", name: "Purdue Boilermakers", shortName: "Purdue",
    seed: 2, region: "West", record: "27-8", wins: 27, losses: 8,
    championshipOdds: 3500, ppg: 79.8, oppPpg: 66.2, scoringMargin: 13.6,
    fg2Pct: 51.4, fg3Pct: 39.2, ftPct: 74.8, threePointRate: 39,
    adjOffRating: 118.1, adjDefRating: 94.8, adjEffMargin: 23.3, pace: 68.2,
    orebRate: 27, drebRate: 75, turnoversForced: 18.4, turnoverRate: 12.8,
    keyPlayers: [{ name: "Braden Smith", stat: "14.9 PPG / 8.7 APG" }, { name: "Fletcher Loyer", stat: "13.6 PPG / 42% 3PT" }],
    playStyle: ["top-3-offense", "three-point-barrage", "pass-first", "efficient"],
    strengthOfSchedule: 8.9, recentForm: "hot", conferenceFinish: "Big Ten 2nd",
    upsetAlert: false, sleeper: false,
    analysis: "Top-3 offense nationally with Braden Smith one of the best point guards in the country. 39% team 3PT rate is sustainable given their shooting pedigree. Their only weakness is interior defense against elite bigs — Gonzaga's Graham Ike poses a real threat."
  },
  {
    id: "gonzaga", name: "Gonzaga Bulldogs", shortName: "Gonzaga",
    seed: 3, region: "West", record: "30-3", wins: 30, losses: 3,
    championshipOdds: 6500, ppg: 84.2, oppPpg: 67.4, scoringMargin: 16.8,
    fg2Pct: 58.2, fg3Pct: 36.4, ftPct: 75.6, threePointRate: 33,
    adjOffRating: 119.8, adjDefRating: 94.1, adjEffMargin: 25.7, pace: 72.1,
    orebRate: 34, drebRate: 73, turnoversForced: 17.8, turnoverRate: 14.4,
    keyPlayers: [{ name: "Graham Ike", stat: "19.7 PPG / 61% inside arc" }, { name: "Braden Huff", stat: "17.8 PPG" }],
    ...
    upsetAlert: false, sleeper: false,
    analysis: "30-3 with 8th-best defense nationally and two elite bigs in Graham Ike and Braden Huff. 61% inside-the-arc for Ike is elite efficiency. Gonzaga's only risk is the WCC schedule — their defense has never faced a pace + 3PT team like Purdue. Elite Eight favorite."
  },
  {
    id: "arkansas", name: "Arkansas Razorbacks", shortName: "Arkansas",
    seed: 4, region: "West", record: "26-8", wins: 26, losses: 8,
    championshipOdds: 5000, ppg: 80.4, oppPpg: 70.1, scoringMargin: 10.3,
    fg2Pct: 52.1, fg3Pct: 44.2, ftPct: 72.4, threePointRate: 38,
    adjOffRating: 115.8, adjDefRating: 97.8, adjEffMargin: 18.0, pace: 73.2,
    ...
    upsetAlert: false, sleeper: true,
    analysis: "Darius Acuff Jr. is playing at an MVP level — 22.2/6.4 on 44% 3PT is historic. Arkansas is HOT entering the tournament, winning 3 games in 5 days to take the SEC title. Acuff can carry them to the Elite Eight or beyond. Biggest sleeper in the West."
  },
  {
    id: "wisconsin", name: "Wisconsin Badgers", shortName: "Wisconsin",
    seed: 5, region: "West", record: "24-10", wins: 24, losses: 10,
    championshipOdds: 7000, ppg: 73.8, oppPpg: 65.4, scoringMargin: 8.4,
  ...
  },
  {
    ...
    championshipOdds: 13000, ppg: 78.4, oppPpg: 70.2, scoringMargin: 8.2,
    ...
    keyPlayers: [{ name: "AJ Dybantsa", stat: "Nation's leading scorer / 28+ PPG in 7 games" }, { name: "Robert Wright III", stat: "22.4 PPG (final 8)" }],
  ...
  },
  {
    ...
    championshipOdds: 25000, ppg: 77.2, oppPpg: 67.8, scoringMargin: 9.4,
  ...
  },
  {
    ...
    upsetAlert: false, sleeper: false,
    analysis: "Three-time champion DNA runs deep at Villanova. Duke Brennan's 14 double-doubles anchor their front court. Top-4 efficiency on both ends of the Big East is legitimately impressive. Utah State in R1 is dangerous but Villanova has been here before."
  },
  {
    id: "utah-state", name: "Utah State Aggies", shortName: "Utah St.",
    seed: 9, region: "West", record: "28-6", wins: 28, losses: 6,
    championshipOdds: 25000, ppg: 76.8, oppPpg: 67.2, scoringMargin: 9.6,
    ...
    strengthOfSchedule: 7.8, recentForm: "hot", conferenceFinish: "Mountain West",
    upsetAlert: false, sleeper: true,
  ...
  },
  {
    ...
    championshipOdds: 25000, ppg: 74.1, oppPpg: 70.8, scoringMargin: 3.3,
  ...
  },
  {
    ...
    championshipOdds: 40000, ppg: 75.8, oppPpg: 70.4, scoringMargin: 5.4,
    ...
    strengthOfSchedule: 9.0, recentForm: "average", conferenceFinish: "Big 12",
    upsetAlert: false, sleeper: false,
    analysis: "18-14 is a below-average record for this seeding but 16th adjusted offensive efficiency tells a different story. Big 12 schedule is brutal. Swain is a matchup problem. Could upset Wisconsin but the record is hard to overlook."
  },
  {
    ...
    strengthOfSchedule: 5.6, recentForm: "hot", conferenceFinish: "Big South",
    upsetAlert: true, sleeper: false,
    analysis: "30-4 record and top-5 turnover forcing is no joke. 64th adjusted offensive efficiency. Their two-scorer attack limits single-player coverage. BYU at 5 is the upset pick — Dybantsa may be too much but don't sleep on High Point."
  },
  {
    id: "hawaii", name: "Hawai'i Rainbow Warriors", shortName: "Hawai'i",
    seed: 13, region: "West", record: "24-8", wins: 24, losses: 8,
    championshipOdds: 150000, ppg: 74.8, oppPpg: 66.4, scoringMargin: 8.4,
    ...
    keyPlayers: [{ name: "Isaac Johnson", stat: "14.1 PPG / 20.5 in Big West tourney / 65% inside arc" }],
  ...
  },
  {
    ...
    upsetAlert: false, sleeper: false,
    analysis: "Tournament hot but conference too weak. Purdue's offense will overwhelm their defense."
  },
  {
    ...
    upsetAlert: false, sleeper: false,
    analysis: "60% inside the arc and 38% from 3 is a potent offensive mix. Ashby is dangerous but Gonzaga's twin towers will be impossible to handle."
  },
  {
  ...
  // ─── MIDWEST REGION ──────────────────────────────────────────────────────
  {
    ...
    championshipOdds: 350, ppg: 82.8, oppPpg: 64.1, scoringMargin: 18.7,
    fg2Pct: 59.4, fg3Pct: 37.2, ftPct: 73.8, threePointRate: 33,
    adjOffRating: 121.4, adjDefRating: 91.8, adjEffMargin: 29.6, pace: 70.8,
    orebRate: 33, drebRate: 77, turnoversForced: 18.8, turnoverRate: 13.1,
    keyPlayers: [{ name: "Yaxel Lendeborg", stat: "14.3 PPG / 7.3 RPG / 1.4 BPG" }],
    ...
    upsetAlert: false, sleeper: false,
    analysis: "Michigan has the best efficiency margin in the country (29.6). 59% on 2s, 37% on 3s, and top-5 on both ends. Lendeborg is a versatile star but the whole roster is pro-ready. AJ Dybantsa and BYU would be their biggest threat in the region. Pre-tournament title co-favorite."
  },
  {
    id: "iowa-state", name: "Iowa State Cyclones", shortName: "Iowa St.",
    seed: 2, region: "Midwest", record: "27-7", wins: 27, losses: 7,
    championshipOdds: 2200, ppg: 78.4, oppPpg: 65.8, scoringMargin: 12.6,
    fg2Pct: 51.8, fg3Pct: 50.2, ftPct: 74.2, threePointRate: 41,
    adjOffRating: 116.8, adjDefRating: 94.2, adjEffMargin: 22.6, pace: 69.4,
    orebRate: 28, drebRate: 74, turnoversForced: 19.2, turnoverRate: 13.8,
    keyPlayers: [{ name: "Milan Momcilovic", stat: "17.0 PPG / 50% 3PT" }, { name: "Joshua Jefferson", stat: "16.6 PPG / 7.4 RPG" }],
    ...
    upsetAlert: false, sleeper: false,
    analysis: "Milan Momcilovic shooting 50% from 3 is historically elite. Jefferson as a do-it-all big gives Iowa State a versatile frontcourt. Top-10 defense makes them a complete team. The path to the Final Four from this region goes through Iowa State."
  },
  {
    id: "virginia", name: "Virginia Cavaliers", shortName: "Virginia",
    seed: 3, region: "Midwest", record: "29-5", wins: 29, losses: 5,
    championshipOdds: 7000, ppg: 72.4, oppPpg: 60.8, scoringMargin: 11.6,
    fg2Pct: 50.8, fg3Pct: 46.8, ftPct: 76.4, threePointRate: 47,
    adjOffRating: 114.2, adjDefRating: 90.4, adjEffMargin: 23.8, pace: 61.2,
    ...
    upsetAlert: false, sleeper: true,
    analysis: "Nation's 6th in offensive rebounding AND 1st in ACC in defensive 3PT allowed. Held to 46% inside the arc. 11.8% turnover rate is the most careful offense in the tournament. Pack-line defense has beaten Michigan-type offenses before. Under the radar Final Four sleeper."
  },
  {
    id: "alabama", name: "Alabama Crimson Tide", shortName: "Alabama",
    seed: 4, region: "Midwest", record: "23-9", wins: 23, losses: 9,
    championshipOdds: 10000, ppg: 91.7, oppPpg: 76.2, scoringMargin: 15.5,
    ...
    upsetAlert: true, sleeper: false,
    analysis: "91.7 PPG — tops in the nation. 4th fastest pace. Alabama can score on anyone but their defense (99.8 adj. def) is exploitable in the tournament. High-variance team — either wins by 20 or loses a shootout. Classic upset candidate in the 4-13 range."
  },
  {
    id: "texas-tech", name: "Texas Tech Red Raiders", shortName: "Texas Tech",
    seed: 5, region: "Midwest", record: "22-10", wins: 22, losses: 10,
    championshipOdds: 11000, ppg: 79.4, oppPpg: 68.4, scoringMargin: 11.0,
  ...
  },
  {
    ...
    championshipOdds: 9000, ppg: 77.8, oppPpg: 65.4, scoringMargin: 12.4,
    fg2Pct: 52.8, fg3Pct: 35.8, ftPct: 73.2, threePointRate: 34,
    adjOffRating: 113.8, adjDefRating: 94.6, adjEffMargin: 19.2, pace: 68.4,
    ...
    upsetAlert: false, sleeper: false,
    analysis: "2nd-best defensive efficiency in the SEC. Top offensive rebounding nationally. Ament + Gillespie is a dangerous backcourt but 22-11 record suggests inconsistency. Kentucky in R1 is dangerous. Ceiling is Elite Eight."
  },
  {
    id: "kentucky", name: "Kentucky Wildcats", shortName: "Kentucky",
    seed: 7, region: "Midwest", record: "21-13", wins: 21, losses: 13,
    championshipOdds: 10000, ppg: 74.8, oppPpg: 69.4, scoringMargin: 5.4,
    ...
    upsetAlert: false, sleeper: false,
    analysis: "21-13 is below Kentucky standards. Oweh is their best player but they lack a true superstar. SEC schedule adds credibility. Tennessee match-up is winnable and this is a spoiler-type team for the first two rounds."
  },
  {
    id: "georgia", name: "Georgia Bulldogs", shortName: "Georgia",
    seed: 8, region: "Midwest", record: "22-10", wins: 22, losses: 10,
    championshipOdds: 30000, ppg: 76.8, oppPpg: 67.4, scoringMargin: 9.4,
  ...
  },
  {
    ...
    championshipOdds: 40000, ppg: 72.8, oppPpg: 65.4, scoringMargin: 7.4,
  ...
  },
  {
    ...
    championshipOdds: 100000, ppg: 77.4, oppPpg: 63.8, scoringMargin: 13.6,
    ...
    strengthOfSchedule: 6.0, recentForm: "hot", conferenceFinish: "MAC Champion",
    upsetAlert: true, sleeper: true,
    analysis: "31-1 record and a 20.4 efficiency margin rivals any power conference team. They're the best mid-major in the field. 62% inside the arc + 38% from 3 + top defense = massive upset potential. 11-seed but should be a 6 or 7. UPSET ALERT against Tennessee."
  },
  {
    id: "smu", name: "SMU Mustangs", shortName: "SMU",
    seed: 11, region: "Midwest", record: "20-13", wins: 20, losses: 13,
    championshipOdds: 35000, ppg: 76.8, oppPpg: 70.4, scoringMargin: 6.4,
    ...
    strengthOfSchedule: 8.4, recentForm: "average", conferenceFinish: "ACC 3rd",
    upsetAlert: false, sleeper: false,
    analysis: "3rd in ACC offense with Miller as an elite shooter. But 20-13 is underwhelming. Would need to beat Miami OH in the play-in to get to the bracket. Good team playing below their potential."
  },
  {
    id: "akron", name: "Akron Zips", shortName: "Akron",
    seed: 12, region: "Midwest", record: "29-5", wins: 29, losses: 5,
    championshipOdds: 50000, ppg: 73.4, oppPpg: 63.8, scoringMargin: 9.6,
    ...
    strengthOfSchedule: 6.8, recentForm: "hot", conferenceFinish: "MAC",
    upsetAlert: true, sleeper: false,
  ...
  },
  {
    ...
    strengthOfSchedule: 6.2, recentForm: "hot", conferenceFinish: "CAA",
    upsetAlert: false, sleeper: false,
  ...
  },
  {
    ...
    strengthOfSchedule: 5.4, recentForm: "hot", conferenceFinish: "Horizon League",
    upsetAlert: false, sleeper: false,
    analysis: "Burch got hot in the tournament but Tennessee's defense is too disciplined for this to be an upset."
  },
  {
    ...
    playStyle: ["turnover-forcing", "two-scorer", "HBCU-pride"],
    strengthOfSchedule: 5.2, recentForm: "hot", conferenceFinish: "SWAC",
    upsetAlert: false, sleeper: false,
  ...
  },
  {
    ...
    championshipOdds: 150000, ppg: 70.8, oppPpg: 63.8, scoringMargin: 7.0,
    ...
    strengthOfSchedule: 5.0, recentForm: "hot", conferenceFinish: "America East",
    upsetAlert: true, sleeper: false,
    analysis: "UMBC literally upset Virginia in the most famous 16-over-1 in history. Their 38% 3PT streak and 13.0 efficiency margin make them dangerous but Michigan is significantly better than 2018 Virginia."
  },
  ...
  // ─── SOUTH REGION ────────────────────────────────────────────────────────
  {
    ...
    championshipOdds: 700, ppg: 79.8, oppPpg: 66.2, scoringMargin: 13.6,
    fg2Pct: 58.8, fg3Pct: 38.4, ftPct: 74.2, threePointRate: 33,
    adjOffRating: 117.8, adjDefRating: 93.2, adjEffMargin: 24.6, pace: 70.2,
    orebRate: 32, drebRate: 75, turnoversForced: 18.4, turnoverRate: 13.8,
    keyPlayers: [{ name: "Thomas Haugh", stat: "17.2 PPG / 6.1 RPG" }, { name: "Alex Condon", stat: "14.8 PPG" }, { name: "Boogie Fland", stat: "11.6 PPG / 1.9 SPG" }],
    ...
    upsetAlert: false, sleeper: false,
    analysis: "Defending national champions with full roster and added hunger. 59% on 2s, 38% on 3s, 11-game shooting streak. Five legitimate scorers make them impossible to single-cover. Boogie Fland's defense (1.9 SPG) disrupts opponents. Florida is the most complete team in the South."
  },
  {
    ...
    adjOffRating: 115.4, adjDefRating: 90.8, adjEffMargin: 24.6, pace: 65.4,
    orebRate: 29, drebRate: 77, turnoversForced: 20.4, turnoverRate: 12.4,
    keyPlayers: [{ name: "Kingston Flemings", stat: "16.5 PPG / 5.4 APG / 38% 3PT" }, { name: "Emanuel Sharp", stat: "15.8 PPG" }],
    ...
    upsetAlert: false, sleeper: false,
    analysis: "3rd in turnover rate (KenPom). One of the best defensive programs in the country under Sampson. Their slow-pace, grind style makes every game ugly and low-scoring which limits upset potential. Flemings + Sharp can score. One game short of winning it all last year."
  },
  {
    ...
    adjOffRating: 120.8, adjDefRating: 96.4, adjEffMargin: 24.4, pace: 71.8,
    orebRate: 31, drebRate: 73, turnoversForced: 18.4, turnoverRate: 14.2,
    keyPlayers: [{ name: "Keaton Wagler", stat: "17.9 PPG / 4.9 RPG / 4.3 APG / 41% 3PT" }, { name: "Kylan Boswell", stat: "13.3 PPG" }],
    ...
    upsetAlert: false, sleeper: false,
    analysis: "Nationally recognized best offense. 80+ PPG in 11 Big Ten games. Wagler is a 4-way stat stuffer who makes Illinois impossible to scheme against. Their only weakness is perimeter defense — vulnerable to Houston's pressure. South Region's dark horse against Florida."
  },
  {
    ...
    adjOffRating: 113.8, adjDefRating: 91.8, adjEffMargin: 22.0, pace: 67.4,
    orebRate: 28, drebRate: 76, turnoversForced: 19.8, turnoverRate: 12.8,
    keyPlayers: [{ name: "Pryce Sandfort", stat: "17.9 PPG / 40% 3PT" }],
    playStyle: ["best-defense-big-ten", "turnover-forcing", "efficient", "defensively-elite"],
    strengthOfSchedule: 9.0, recentForm: "hot", conferenceFinish: "Big Ten",
    upsetAlert: false, sleeper: true,
    analysis: "Best defense in the Big Ten. Opponents shoot just 30% from 3 against them. Force turnovers on ~20% of possessions. Sandfort is a clutch shooter. Nebraska is making their first NCAA tournament appearance and the story will fuel them. Could reach Elite Eight."
  },
  {
    id: "vanderbilt", name: "Vanderbilt Commodores", shortName: "Vanderbilt",
    seed: 5, region: "South", record: "26-8", wins: 26, losses: 8,
    championshipOdds: 6500, ppg: 78.4, oppPpg: 67.8, scoringMargin: 10.6,
  ...
  },
  {
    ...
    championshipOdds: 11000, ppg: 78.8, oppPpg: 68.4, scoringMargin: 10.4,
    ...
    strengthOfSchedule: 8.8, recentForm: "hot", conferenceFinish: "ACC",
    upsetAlert: false, sleeper: false,
    analysis: "Wilson is a double-double machine and a nightmare against smaller lineups. UNC's transition game and size creates problems. Top-50 defense rounds them out. Their matchup with Saint Mary's in R2 is the most interesting first-weekend game in the South."
  },
  {
    id: "saint-marys", name: "Saint Mary's Gaels", shortName: "St. Mary's",
    seed: 7, region: "South", record: "27-5", wins: 27, losses: 5,
    championshipOdds: 25000, ppg: 74.8, oppPpg: 63.4, scoringMargin: 11.4,
    ...
    upsetAlert: false, sleeper: true,
    analysis: "27-5 with a 21.0 efficiency margin against WCC competition. Lewis on a tear (22.6 PPG last 5). Their best-case scenario has them matching up well with UNC — both slow-pace, interior-focused teams. Saint Mary's is consistently underseeded. Don't sleep on them."
  },
  {
    id: "clemson", name: "Clemson Tigers", shortName: "Clemson",
    seed: 8, region: "South", record: "24-10", wins: 24, losses: 10,
    championshipOdds: 20000, ppg: 72.4, oppPpg: 63.8, scoringMargin: 8.6,
  ...
  },
  {
    ...
    championshipOdds: 20000, ppg: 76.8, oppPpg: 70.4, scoringMargin: 6.4,
  ...
  },
  {
    ...
    championshipOdds: 20000, ppg: 73.4, oppPpg: 67.8, scoringMargin: 5.6,
  ...
  },
  {
    ...
    championshipOdds: 40000, ppg: 73.8, oppPpg: 64.8, scoringMargin: 9.0,
  ...
  },
  {
    ...
    championshipOdds: 150000, ppg: 77.2, oppPpg: 67.2, scoringMargin: 10.0,
    ...
    upsetAlert: true, sleeper: false,
    analysis: "#1 nationally in turnovers forced per possession. 28-5 and on a hot streak. Garcia can go off. Their defensive pressure could rattle Vanderbilt's guards. Classic 12-seed upset pick and one of the best 12-seeds in recent memory."
  },
  {
    id: "troy", name: "Troy Trojans", shortName: "Troy",
    seed: 13, region: "South", record: "22-11", wins: 22, losses: 11,
    championshipOdds: 150000, ppg: 73.4, oppPpg: 65.8, scoringMargin: 7.6,
    ...
    strengthOfSchedule: 6.0, recentForm: "hot", conferenceFinish: "Sun Belt",
    upsetAlert: false, sleeper: false,
  ...
  },
  {
    ...
    championshipOdds: 100000, ppg: 70.8, oppPpg: 66.4, scoringMargin: 4.4,
    ...
    strengthOfSchedule: 6.2, recentForm: "average", conferenceFinish: "Ivy League",
    upsetAlert: false, sleeper: false,
    analysis: "Ivy League champion but their SOS is too weak. UNC's athleticism advantage is overwhelming."
  },
  {
    ...
    keyPlayers: [{ name: "Big Sky Four", stat: "52 PPG combined in tourney" }],
  ...
  },
  {
    ...
    strengthOfSchedule: 4.4, recentForm: "average", conferenceFinish: "Patriot",
    upsetAlert: false, sleeper: false,
    analysis: "18-16 record is an all-time low for a 16-seed. Whitlock can shoot but Florida's five-scorer attack will be overwhelming."
  },
  {
    ...
    strengthOfSchedule: 4.2, recentForm: "hot", conferenceFinish: "SWAC Champion",
    upsetAlert: false, sleeper: false,
    analysis: "18-17 is the worst record in tournament history for a team that isn't a play-in qualifier. They play Florida — this is a feel-good story that ends quickly."
  }
];
...
export const FIRST_FOUR = [
  ...
  { region: "South" as Region, seed: 16, teams: ["lehigh", "prairie-view"] }
];
